...
const keys = ['slug', 'title', 'platform', 'region', 'launched'] as Exclude<
  keyof SoftwareParsedContent,
  number
>[]
type SoftwareListData = Pick<SoftwareParsedContent, typeof keys[number]>
